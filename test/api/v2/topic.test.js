...
describe('test/api/v2/topic.test.js', function () {
    ...
    describe('get /api/v2/topics', function () {
        it('should return topics', function (done) {
            request.get('/api/v2/topics')
    ...
    describe('get /api/v2/topic/:topicid', function () {

        it('should return topic info', function (done) {
            request.get('/api/v2/topic/' + mockTopic.id)
                .end(function (err, res) {
                    should.not.exists(err);
                    res.body.success.should.true();
        ...
        it('should fail when topic_id is not valid', function (done) {
            request.get('/api/v2/topic/' + mockTopic.id + 'not_valid')
                .end(function (err, res) {
                    should.not.exists(err);
        ...
        it('should fail when topic not found', function (done) {
            ...
            request.get('/api/v2/topic/' + notFoundTopicId)
                .end(function (err, res) {
                    should.not.exists(err);
    ...
    describe('post /api/v2/topics', function () {
    ...
    describe('post /api/v2/topics/update', function () {
        it('should update a topic', function (done) {
            request.post('/api/v2/topics/update')
                .set('Authorization', 'Bearer ' + mockUser.accessToken)
                .send({
                ...
                .end(function (err, res) {
                    should.not.exists(err);
                    res.body.success.should.true();
                    res.body.topic_id.should.eql(mockTopic.id);
                    done();
                });
        })
    })
